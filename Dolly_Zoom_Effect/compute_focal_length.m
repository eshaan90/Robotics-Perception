...
% 
% In this function, multiple camera positions are given. The camera is
% placed on z axis and thus only z axis for the camera position is given.
% We compute corresponding focal length to achieve Dolly Zoom
...
% Output:
% - f: 1 by n, camera focal length, each element corresponds to an element in pos, i.e., 
% f(i) is the focal length for Dolly Zoom effect when the camera is placed at pos(i)
